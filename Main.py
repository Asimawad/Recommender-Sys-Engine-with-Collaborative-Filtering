...
if __name__ == "__main__":
    ...
    # Best Parameters after grid Search-> lambda_reg: 0.5, gamma: 0.5, taw: 10, K_factors: 30
    # Initialize and train the model
    model = RecommendationModel(n_users = n_users, n_movies = n_movies, num_features = num_features,K_factors=K_factors,lambda_reg=0.5,gamma=0.5,taw=10,n_epochs=EPOCHS,jitter=1e-8)
