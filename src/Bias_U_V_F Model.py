...
experiment_name = "ASIM_2912"  # Customize this name
...
K_factors = 25 ; n_Epochs = 20 ;  lambda_reg = 1 ; gamma = 0.1 ; taw =  10 ; std = np.sqrt(K_factors)
jitter = 1e-8
...
genre_factors = np.random.normal(loc=0, scale = 1/std, size=(num_features,K_factors))
...
for EPOCH in range(n_Epochs):
    ...
    # Perform the updates onscikit-learn movies
